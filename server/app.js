...
app.use(Uri, require("./dashboard/api"));
app.use(Uri, require("./admin/api"));
app.use(Uri, require("./developer/api"));
app.use(Uri, require("./interaction/api"));
app.use(Uri, require("./catalog/api"));
app.use(Uri, require("./sbuject/api"));
app.use(Uri, require("./register/api"));